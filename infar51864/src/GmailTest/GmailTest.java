...
import GmailWeb.GmailLogin;
import GmailWeb.MailPage;
...
public class GmailTest {
	...
	public static void main(String[] args) throws InterruptedException, AWTException
	{
		//************************************ Page Objects *************************************https://dev23478.service-now.com/
		 GmailWeb.GmailLogin pgLogin = new GmailWeb.GmailLogin();
		 GmailWeb.MailPage pgHome = new GmailWeb.MailPage();
		...
		pgHome.sendemail(globalDriver, "prasannarhegde@gmail.com", "Test FAST", "Test Fast Contnent");
