...
public class OpenBrowser {
	...
	public  class ButtonClickListener implements ActionListener{
		...
		//	System.out.println("system URL is "+ strurl);
			if ( e.getActionCommand().equals("Open"))
			{
				...
				if (strurl.contains("http") == false && strurl.contains(".html") == false)
				{
					ShowPopupMessage("URL is Invalid Please Enter Correct URL", "Icorrect URL");
					return;
				}
				try {
					setupdriverIE(strurl);
	...
	public static void  setupdriverIE(String baseurl) throws InterruptedException
	{
