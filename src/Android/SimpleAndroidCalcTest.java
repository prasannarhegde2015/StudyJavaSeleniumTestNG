...
public class SimpleAndroidCalcTest {
	...
	public void setUp() throws MalformedURLException {
		...
		capabilities.setCapability("deviceName", "Nexus_5_API_23_x86");
	...
	public void Sum() {
		...
		if (result.equals("7"))
		{
			System.out.println("Test has Passed"+" Expected Result: 7"+"Actual Result "+result);
		}
		else
		{
			System.out.println("Test has Failed"+" Expected Result: 7"+"Actual Result "+result);
		}
	}
